...
export const AnnotatorMainHTML = new TemplateFn<AnnotatorMain>(function (html, props) {
	return html`
		<div id="selecter">
			...
			<annotator-instance filename=${this.props.fileNames[this.props.selected] || null}></annotator-instance>
		</div>
	`;
