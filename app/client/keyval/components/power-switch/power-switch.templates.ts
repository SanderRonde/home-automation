...
export const PowerSwitchHTML = new TemplateFn<PowerSwitch>(function (html, props) {
	return html`
		<label id="label" class="${['mdl-switch', 'mdl-js-switch', 'is-upgraded', {
			'is-checked': props.initial
		}]}" for="switch">
			<input @change="${this.onChange}" type="checkbox" id="switch" class="mdl-switch__input" ?checked="${props.initial}">
			<span class="mdl-switch__label"></span>
		</label>
	`;
}, CHANGE_TYPE.PROP, render);

export const PowerSwitchCSS = new TemplateFn<PowerSwitch>((html, props) => {
