...
import { Props, config, PROP_TYPE } from '../../../../../node_modules/wc-lib/build/es/wc-lib.js';
...
@config({
	...
	html: InfoScreenHTML,
	css: InfoScreenCSS,
	dependencies: [CurrentDate, TemperatureDisplay, CalendarOverview, AdvancedTemperatureDisplay],
})
