...
export function remoteControlHTML(randomNum: number) {
	...
	<head>
		...
		<link rel="stylesheet" href="/remote-control/paper-ripple.min.css?n=${randomNum}">
		<link rel="stylesheet" href="/remote-control/page.css?n=${randomNum}">
		<link rel="manifest" href="/remote-control/manifest.json?n=${randomNum}">
	...
	<body>
			...
			<div id="dialogVerticalCenterer">
				<div id="dialogHorizontalCenterer">
					<div id="dialog">
						...
						<input type="number" id="dialogInput" label="volume" placeholder="volume"/>
						<div id="dialogButtons">
							<div class="rippleTarget blueRipple" id="cancelButton">Cancel</div>
							<div class="rippleTarget blueRipple" id="okButton">Ok</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="main">
			...
			<div id="volumeRow">
				<div class="rippleTarget" id="volumeDown">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M18.5 12c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM5 9v6h4l5 5V4L9 9H5z"/>
						<path d="M0 0h24v24H0z" fill="none"/>
					</svg>
				</div>
				<div class="rippleTarget" id="playpause">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
		...
		<div id="statusContainer">
			...
			<div id="networkStatus">
				...
				<path d="M23.64 7c-.45-.34-4.93-4-11.64-4-1.5 0-2.89.19-4.15.48l10.33 10.32 5.46-6.8zm-6.6 8.22l-13.77-13.78-1.27 1.28 2.05 2.06c-2.14.98-3.46 2.04-3.69 2.22l11.63 14.49.01.01.01-.01 3.9-4.86 3.32 3.32 1.27-1.27-3.46-3.46z"></path>
				</svg>
			</div>
		</div>
