declare module "castv2-player" {
	...
	interface PersistentPlayer {
		_playlist: Playlist;
		queueLoadPromise(player: PersistentPlayer, list: any[], config: {
			startIndex: number;
			repeatMode: string;
		}): Promise<void>;
	}
	...
	export class MediaPlayerClass {
		...
		setRepeatModePromise(repeatMode: 'REPEAT_OFF'|'REPEAT_ALL'|'REPEAT_SINGLE'|'REPEAT_ALL_AND_SHUFFLE'): Promise<void>;
	...
	namespace playlist {
		class Playlist {
			...
			_addItems(metaInfo: {
				...
				contentType: string;
				metadata: Object;
			}[], options?: any, something?: boolean): Object[];
		}
	}
